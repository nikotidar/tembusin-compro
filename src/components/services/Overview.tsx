function Overview() {
  return (
    <div className="md:py-[80px] py-10 px-4 bg-[#D5DAEB] flex flex-col items-center justify-center">
      ...
      <div className="text-center max-w-3xl text-[#364152] md:text-[22px] text-lg font-normal leading-[140%] tracking-[0.36px] md:tracking-[0.44px]">
